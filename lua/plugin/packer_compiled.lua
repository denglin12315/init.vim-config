...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/ldeng/.local/share/nvim/site/pack/packer/start/coc.nvim",
  ...
  gutentags_plus = {
    loaded = true,
    path = "/home/ldeng/.local/share/nvim/site/pack/packer/start/gutentags_plus",
  ...
  ["vim-gutentags"] = {
    loaded = true,
    path = "/home/ldeng/.local/share/nvim/site/pack/packer/start/vim-gutentags",
